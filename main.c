...
*              Infineon MCU and how to add a custom fault handling function to
...
********************************************************************************
* Summary:
*  This is the main function for infineon device CPU. This function
*    1. initializes BSP
...
int main(void)
{
    ...
    printf("****************** "
           " Infineon MCU: Fault Handling Basics "
           "******************\r\n\n");
    ...
    for (;;)
    {
        result = mtb_hal_uart_get(&DEBUG_UART_hal_obj, &cmd, 1);
